...
function val=Nw_tilda_top(tu)
    global gamma_w_ed pw alpa;
    syms r;
       val=2*int(r*acos(r/2*tu)*exp(-(gamma_w_ed/pw)*r^alpa),'r',0,2*tu);
end
function  val=secend_exp(lambda_w,lambda_l_tilda,tu)
    global pl gamma_w_ed;
    syms t;
